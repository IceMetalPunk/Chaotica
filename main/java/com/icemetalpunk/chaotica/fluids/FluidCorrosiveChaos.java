...
public class FluidCorrosiveChaos extends FluidChaosBase {
	...
	protected static final ResourceLocation stillModel = new ResourceLocation(Chaotica.MODID, "fluids/corrosive_chaos_still.png");
	protected static final ResourceLocation flowingModel = new ResourceLocation(Chaotica.MODID, "fluids/corrosive_chaos_flowing.png");

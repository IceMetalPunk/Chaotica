...
public class FluidPureChaos extends FluidChaosBase {
	...
	protected static final ResourceLocation stillModel = new ResourceLocation(Chaotica.MODID, "fluids/pure_chaos_still");
	protected static final ResourceLocation flowingModel = new ResourceLocation(Chaotica.MODID, "fluids/pure_chaos_flowing");
